    ...
    <header>
        <div class="header-content">
            <div class="header-content-inner">
                <h1 id="homeHeading">Administrar Roles</h1>
                <hr>
                <form action="IrAltaRol.html" method="post" >
	 				<input type="submit" name="NuevoRol" value="Nuevo Rol" class="btn btn-primary btn-xl page-scroll">
				</form>
				<br><br>
<!--                 <a href="AltaUsuario.jsp" class="btn btn-primary btn-xl page-scroll">NUEVO USUARIOS</a><br><br><br> -->
				<a class="btn btn-primary btn-xl page-scroll" href="<c:url value='/IrListarRoles.html' />"  >LISTA DE ROLES</a><br><br><br>
            </div>
        </div>
    </header>
